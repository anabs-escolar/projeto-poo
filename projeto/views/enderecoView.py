...
class EnderecoView:
    def endereco_inserir(
        logradouro, num_casa, complemento, bairro, cidade, estado, cep, id_cliente
    ):
        try:
    ...
    def endereco_atualizar(
        id, logradouro, num_casa, complemento, bairro, cidade, estado, cep, id_cliente
    ):
